...
describe("createLenderProduct", () => {
  it("inserts rate_type as uppercase enum value", async () => {
    const query = vi
      .fn()
      .mockResolvedValueOnce({ rows: [{ column_name: "id" }, { column_name: "lender_id" }, { column_name: "name" }, { column_name: "active" }, { column_name: "country" }, { column_name: "rate_type" }, { column_name: "interest_min" }, { column_name: "interest_max" }, { column_name: "term_min" }, { column_name: "term_max" }, { column_name: "term_unit" }, { column_name: "category" }, { column_name: "type" }, { column_name: "required_documents" }, { column_name: "created_at" }, { column_name: "updated_at" }] })
