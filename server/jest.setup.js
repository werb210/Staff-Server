...
process.env.JWT_SECRET = process.env.JWT_SECRET || "test-secret-12345678901234567890";
process.env.ACCESS_TOKEN_SECRET = process.env.ACCESS_TOKEN_SECRET || "access-secret-123456789012345678901";
process.env.REFRESH_TOKEN_SECRET = process.env.REFRESH_TOKEN_SECRET || "refresh-secret-123456789012345678";
