...
const uploadDir = path_1.default.join(process.cwd(), "uploads", "ai-issues");
...
router.post("/knowledge/upload", knowledge_controller_1.upload.single("file"), knowledge_controller_1.AIKnowledgeController.upload);
...
router.post("/report-issue", upload.single("screenshot"), (0, safeHandler_1.safeHandler)(async (req, res, next) => {
    const body = req.body;
