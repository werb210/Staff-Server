...
exports.getOcrFieldRegistry = getOcrFieldRegistry;
exports.getOcrFieldDefinitionByKey = getOcrFieldDefinitionByKey;
exports.getOcrFieldDefinitionByLabel = getOcrFieldDefinitionByLabel;
...
function getOcrFieldRegistry() {
    return [...exports.OCR_FIELD_REGISTRY];
}
function getOcrFieldDefinitionByKey(key) {
    return exports.OCR_FIELD_REGISTRY.find((field) => field.field_key === key);
}
function getOcrFieldDefinitionByLabel(label) {
