...
exports.getHumanSessions = getHumanSessions;
...
async function processChatMessage(params) {
    ...
    const session = await (0, chat_repo_1.getSessionById)(params.sessionId);
    if (!session) {
    ...
    const count = await (0, chat_repo_1.getMessageCount)(params.sessionId);
...
async function getHumanSessions() {
