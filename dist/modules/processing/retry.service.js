...
const OCR_BREAKER = (0, circuitBreaker_1.getCircuitBreaker)("ocr_job_creation", {
    failureThreshold: 3,
    cooldownMs: 60000,
});
const BANKING_BREAKER = (0, circuitBreaker_1.getCircuitBreaker)("banking_job_creation", {
    failureThreshold: 3,
    cooldownMs: 60000,
});
const CREDIT_BREAKER = (0, circuitBreaker_1.getCircuitBreaker)("credit_summary_generation", {
    failureThreshold: 3,
    cooldownMs: 60000,
});
function getBreaker(jobType) {
    switch (jobType) {
        case "ocr":
            return OCR_BREAKER;
        case "banking":
...
async function retryProcessingJob(params) {
    if (!(0, config_1.getRetryPolicyEnabled)() && !params.force) {
