...
export async function createContinuation(applicationId) {
...
export async function updateContinuationStep(token, currentStep) {
    await db.query(`
...
export async function completeContinuation(token) {
    await db.query(`
      update continuation_sessions
