...
// Pure unit-level assertion of the routing rule, independent of the
// route handler. The runtime path uses the same arithmetic.
...
describe("BF_SERVER_BLOCK_v84 — closing-costs companion routing by amount", () => {
