...
export const ROUTES: ApiRoute[] = [
  ...
  { method: "GET", path: "/api/twilio/token", roles: [] },
  ...
  { method: "GET", path: "/api/public/readiness/bridge/:sessionToken", roles: [] },
  { method: "GET", path: "/api/readiness/bridge/:sessionToken", roles: [] },
  { method: "POST", path: "/api/credit-readiness", roles: [] },
  { method: "GET", path: "/api/credit-readiness/session/:token", roles: [] },
